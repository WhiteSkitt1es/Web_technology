<?php
$job = [
'job_name' => ['Пожарный', 'Полицейский', 'Врач'],
'job_data' => ['Dec 2012 - Настоящее время', 'Nov 2011 - Dec 2012', 'Oct 2010 - Nov 2011'],
'job_work' => ['Ликвидировал пожары.', 'Защищал гражданскую безопастность.', 'Спасал человеческие жизни.']
]
?>
<!DOCTYPE html>
<html>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
            ...
            <p><?php echo $job['job_work'][2]; ?></p><br>
        </div>
    </div>
